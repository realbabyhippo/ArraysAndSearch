...
In this submission there are 4 class files and one text files. The 4 class files are Rectangle.java, Problem1.java, Problem2.java and Problem3.java. You can compile all these files by typing in <javac CLASSNAME.java> and you can run these files by typing in < java CLASSNAME >.
